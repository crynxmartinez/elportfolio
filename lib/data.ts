...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "White-label SEO delivery for B2B and local service businesses — keyword research, content programmes and technical fixes, run end to end behind an agency's brand. Client identities are withheld under NDA.",
...
export const PROJECT_GROUPS: ProjectGroup[] = [
  ...
  },
  {
    ...
    blurb:
      "White-label SEO delivered behind an agency's brand: they brought the client, I did the work. Client names and data are withheld under NDA, so this is listed as experience rather than as a case study with published results.",
    slugs: ["agency-seo"],
  },
  {
    id: "platforms",
